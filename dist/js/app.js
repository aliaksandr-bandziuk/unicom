(() => {
    ...
    const hamburger_isMobile = {
        ...
        any: function() {
            return hamburger_isMobile.Android() || hamburger_isMobile.BlackBerry() || hamburger_isMobile.iOS() || hamburger_isMobile.Opera() || hamburger_isMobile.Windows();
        }
    };
    if (hamburger_isMobile.any()) {
